...
declare class SEGMiddlewareRunner extends NSObject {
	...
	constructor(o: { middlewares: NSArray<SEGMiddleware> | SEGMiddleware[]; });

	initWithMiddlewares(middlewares: NSArray<SEGMiddleware> | SEGMiddleware[]): this;
...
declare class SEGUtils extends NSObject {
	...
	static traverseJSONAndReplaceWithFilters(object: any, patterns: NSDictionary<string, string>): any;
}
